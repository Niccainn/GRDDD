...
| 4 | THE SOLUTION | "Not a second brain. A business nervous system." | Three columns: Environments → Systems → Workflows. Subtitle: "Everything is connected. Everything acts. Everything learns." Merge current slides 4+5 (architecture + Nova) — add Nova capabilities as bullet list in a right-hand card. |
