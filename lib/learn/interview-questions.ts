 ...
 * describe what they want Atrium to run can always answer these. The
 * answers feed Atrium, not the other way around; Atrium writes the
 * proposal.
 *
...
export const INTERVIEW_QUESTIONS: InterviewQuestion[] = [
  {
    ...
    why: 'Tells Atrium the rhythm of your week and where the most painful recurring work starts.',
  },
  {
    id: 'hate',
  ...
  },
  {
    ...
    why: 'Gives Atrium the direction of travel — so today\'s actions compound.',
  },
];
