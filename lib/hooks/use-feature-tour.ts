...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    title: 'Meet Atrium',
    description: 'Your AI assistant. Ask Atrium to create tasks, analyze your workspace, or run workflows. Try: "What needs my attention?"',
    position: 'bottom',
    page: '/dashboard',
  },
  {
    ...
    title: 'Systems',
    description: 'Systems organize your workflows and goals. Each system tracks its own health score — Atrium monitors these for you.',
    position: 'right',
    page: '/dashboard',
  },
  {
  ...
  },
  {
    ...
    title: 'Workflows',
    description: 'Build multi-stage workflows for repeatable processes. Run them manually or ask Atrium to trigger them.',
    position: 'right',
  },
  {
    id: 'sidebar-goals',
    target: 'a[href="/goals"]',
    title: 'Goals',
    description: 'Set OKRs with measurable targets. Track progress and Atrium can update them based on your work.',
    position: 'right',
  },
  {
    id: 'sidebar-nova',
    ...
    description: 'Full AI console with interaction history. Atrium can create tasks, run workflows, and analyze cross-system patterns.',
    position: 'right',
  },
  {
    id: 'sidebar-search',
