 ...
 *
 * This UI is the user-facing answer to "why did Atrium do that?" and
...
export const metadata = {
  title: 'Traces · Atrium observability',
  description: 'Every reasoning step, tool call, and decision Atrium has made across your organization.',
};
